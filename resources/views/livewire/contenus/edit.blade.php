          ...
          <div class="card-body">
            <div class="form-group">
              ...
              <div class="col-md-12" wire:ignore>
                <input id="edit_titre" class="form-control @error('edit_titre') is-invalid @enderror"
                  wire:model="edit_titre">
              </div>
              @error("edit_titre")
            ...
            <div class="form-group">
              ...
              <div class="col-md-12" wire:ignore>
                <textarea id="edit_extrait" class="form-control @error('edit_extrait') is-invalid @enderror"
                  wire:model="edit_extrait">
                                </textarea>
              </div>
              @error("edit_extrait")
              <span class="text-danger">{{ $message }}</span>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12" wire:ignore>
                <textarea id="edit_contenu" class="form-control @error('edit_contenu') is-invalid @enderror"
                  wire:model="edit_contenu">
                                  </textarea>
              </div>
              @error("edit_contenu")
              <span class="text-danger">{{ $message }}</span>
            ...
            <div class="form-group">
              <label class="control-label">Titre</label>
              <div class="col-md-12" wire:ignore>
                <input id="edit_title" class="form-control @error('edit_title') is-invalid @enderror"
            ...
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  ...
                  <select class="form-control @error(" edit_type") is-invalid @enderror" wire:model="edit_type"
                    disabled>
                    ...
                    <option value="blog_13">section_text_autre</option>
                  </select>
                  @error("edit_type")
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
            ...
            <div class="p-4">
              ...
              <div class="custom-file mt-3">
                <input type="file" wire:model='new_imageUrl' class="custom-file-input @error(" new_imageUrl") is-invalid
            ...
            <div class="card-footer">
              <div class="float-right">
                <button type="button" wire:click="goToListContenu()" class="btn btn-danger">Retouner à la liste des
                  contenus</button>
              </div>
