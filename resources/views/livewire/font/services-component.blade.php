  ...
  <section id="team" class="team section-bg">
    <div class="container">
      ...
      <h1 class="policetire">
        ...
        {!!$contenu->titre!!}
        @endif
        @if ($contenu->type=="blog_9"&& app()->getLocale() == 'en')
        {!!$contenu->title!!}
        @endif
        @endforeach
      </h1>
      ...
      <div class="row">
        ...
        <div class="rowv pilicecon">
          ...
          @endforeach
          {{-- <p>
            Le terrain est impitoyable, tout comme le bois sacré. Nous avons developpé la culture du courage. Y compris
            le courage de se remettre en cause. <br>
          </p> --}}
          <br>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
          ...
          <div class="col">
            <div class="card" style="border:none;" type="button" data-bs-toggle="modal"
              ...
              <div class="card-body ">
                ...
                <div class="d-flex justify-content-end ">
                  <a class="noir gras text-just" href="#" data-bs-toggle="modal"
                    data-bs-target="#exampleModal{{$service->id}}">{{app()->getLocale()=='fr'?'En savoir plus':'See
                    more'}}</a>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body ">
                  ...
                  {{-- <p class="card-text ">This is a wider card with supporting text below as a natural lead-in to
                    additional content. This content is a little bit longer.</ --}} <div
