  ...
  <section id="team" class="team section-bg">
    <div class="container">
      ...
      <h1 class="policetire">
        ...
        {!!$contenu->titre!!}
        @endif
        @if ($contenu->type=="blog_12" && app()->getLocale() == 'en')
        {!!$contenu->title!!}
        @endif
        @endforeach
      </h1>
      ...
      <div class="row">
        ...
        <div class="row pilicecon">
          ...
          @endforeach
          {{-- <p>
            Votre avis compte, il nous permet de mieux vous servir et d’affiner nos offres. Y compris le courage de se
    ...
    <div class="container">
      <div>
        <iframe style="border:0; width: 100%; height: 270px;"
          src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3972.121959165805!2d-3.9730758!3d5.3983832!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfc195f732d66469%3A0x5d63b083915f0c4a!2sSUZANG%20Group!5e0!3m2!1sfr!2sci!4v1673866156328!5m2!1sfr!2sci"
      ...
      <div class="row mt-5">
        ...
        <div class="col-lg-8 mt-5 mt-lg-0">
          ...
          <div class="row">
            ...
            <div class="col-md-6 form-group mb-3 mt-3 mt-md-0">
              <input type="text" name="telephone" class="form-control telephone" id="telephone" placeholder="Telephone"
                required>
            </div>
            <div class="col-md-6 form-group mb-3 mt-3 mt-md-0">
              <input type="email" class="form-control adresse" name="adresse" id="adresse" placeholder="Votre adresse"
                required>
            </div>
          ...
          <div class="text-center add_contact btn btn-secondary "><button class="btn btn-secondary"
