  ...
  <section id="portfolio" class="portfolio">
    ...
    <div class="container">
      ...
      <h1 class="policetire">
        ...
        {!!$contenu->titre!!}
        @endif
        @if ($contenu->type=="blog_10" && app()->getLocale() == 'en')
        {!!$contenu->title!!}
        @endif
        @endforeach
      </h1>
              ...
              <div class="portfolio-wrap">
                ...
                <div class="portfolio-info">
                  ...
                  <div class="portfolio-links">
                    <a href="{{asset('storage')}}/{{$client->imageUrl}}" data-gallery="portfolioGallery"
                      class="portfolio-lightbox" title="{{$client->titre}}"><i class="bx bx-plus"></i></a>
